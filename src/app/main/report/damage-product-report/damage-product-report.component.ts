...
@Component({
  selector: 'app-damage-product-report',
  templateUrl: './damage-product-report.component.html',
  styleUrls: ['./damage-product-report.component.scss']
})
export class DamageProductReportComponent implements OnInit {
  ...
  loadData(id:number,page?: number): void {
    ...
    this.reportService.damageReport(id,{
      page: this.page,
      size: this.size,
      from:  formDt,
      to:   toDt
